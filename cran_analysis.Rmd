...
Talking about packages is nice. But behind them lies people. And a lot of people. For the top packages shown before, `r nb_multi_authors` of them are multi-authors packages (I counted all roles like authors or creator). And some have a lot of contributors, like the `{ape}` package. Some heterogeneity in role declarations could make it difficult to compare across packages.
